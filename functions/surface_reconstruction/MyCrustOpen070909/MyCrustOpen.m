...
% fprintf_('Manifold extraction Time: %4.4f s\n',toc)



time=etime(clock,starttime);
% fprintf_('Total Time: %4.4f s\n',time)
...
% fprintf_('\tFinal size of the queue is %4.0f edges were %4.0f \n',nf,nume)
%
